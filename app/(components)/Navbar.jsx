...
export default function Navbar() {
    return (
        <div className="absolute left-1/2 top-[10px] transform -translate-x-1/2 shadow-2xl p-2 flex justify-center items-center">
            <div className="bg-black flex items-center py-1 px-1 gap-2 rounded-full text-white border-gray-300 border-2 shadow-2xl shadow-white/30 hover:py-2 hover:px-2 transition-all ease-in-out duration-300">
            <Link 
