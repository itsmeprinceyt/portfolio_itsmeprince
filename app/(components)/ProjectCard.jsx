    ...
    return (
        <>
            <div className="bg-neutral-950  hover:shadow-white/30 p-4 rounded-md col-span-1 sm:col-span-2 border-2 shadow-2xl shadow-white/20 flex flex-col gap-3">
                ...
                <div className="bg-neutral-800 rounded-full p-2 flex justify-center items-center gap-2 text-white">
                {Tags.map((tag, index) => (
                    <div key={index} className="bg-neutral-950 p-2 rounded-full px-3 text-xs">
                        {tag}
                    </div>
                ))}
            </div>
