...
export default function SkillIconTag({ name, file }: SkillIconProps) {
    return (
        <div className="relative inline-flex items-center gap-2 rounded-md border border-neutral-700/20 bg-white p-2 text-sm text-stone-700 shadow-lg shadow-white/10 hover:shadow-white/20 transition-all hover:scale-x-105 ease-in-out duration-150 group">
