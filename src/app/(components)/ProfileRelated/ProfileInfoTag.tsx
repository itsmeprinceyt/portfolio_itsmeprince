...
export default function ProfileInfoTag({ text, name, href }: ProfileInfoTagProps) {
    const content = (
        <div
            className={`bg-black text-stone-200 hover:text-stone-100 shadow-lg shadow-stone-400/10 border border-stone-400/20 p-1.5 px-3 rounded-lg text-xs flex items-center gap-2 hover:scale-105`}
        >
