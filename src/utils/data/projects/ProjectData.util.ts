...
export const majorProjects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A beautifully semi-dynamic e-commerce website designed to elevate experience for crochet, embroidery, and customized crafts using Next.js, TypeScript, and modern frontend tools.",
    full_description: {
      intro:
      ...
      features: [
        {
          ...
          detail:
            "The chatbot is available to assist users with a wide range of needs, including product information, checkout, website navigation, order status, and contact support. It provides help in both Hindi and English, ensuring a seamless experience for all users.",
        },
        {
          title: "Product Listings & Detail Pages",
          detail:
            "Showcases products with high-quality images, clear titles, and custom features, variations, and care instructions.",
        },
        {
          title: "Image Gallery with Fullscreen Support",
          detail:
            "Utilizes Swiper.js to provide a modern, responsive carousel and fullscreen preview for product images.",
        },
        {
          title: "Cart System with WhatsApp Checkout",
          detail:
            "Allows users to add products to a cart and checkout directly via WhatsApp with pre-filled cart data.",
        },
        {
          title: "Persistent Cart via localStorage",
          detail:
            "Cart data is saved in localStorage, ensuring it remains even after a page refresh or browser restart.",
        },
        {
          title: "Discount Feature",
          detail:
            "Supports showing discounted prices for select products, encouraging conversions.",
        },
        {
          title: "Product Search",
          detail:
            "Fast, dynamic product search module helps customers find items instantly.",
        },
        {
          title: "SEO-Friendly",
          detail:
            "Clean URLs, dynamic metadata, and well-structured pages for better search engine indexing.",
        },
        {
          title: "Mobile Responsive",
          detail:
            "Optimized layout and interaction patterns for smooth mobile and desktop experiences.",
        },
      ],
      dependencies: ["Swiper.js", "React Hot Toast", "WhatsApp API"],
      usage_examples: [
    ...
    links: {
      ...
      github: {
        url: `https://github.com/itsmeprinceyt/crafti-nagma`,
        enabled: true,
      },
  ...
  },
  {
      ...
      features: [
        {
          ...
          detail:
            "Secure sign-up and login system with JWT tokens to maximize data protection and session integrity.",
        },
        {
          title: "User Profiles",
          detail:
            "Each user has a personal profile showcasing their posts, interactions, and basic account information.",
        },
        {
          title: "Post System",
          detail:
            "Users can create, edit, and delete posts to share their thoughts and feelings.",
        },
        {
          title: "Like System",
        ...
        },
        {
          ...
          detail:
            "Regex-based search to find users by their username or email.",
        },
        {
          title: "Responsive UI",
          detail:
            "Fully responsive layout that works across mobile and desktop devices.",
        },
        {
          title: "Post Feed",
          detail:
            "View a centralized feed with the latest posts from all users in real-time.",
        },
      ],

      dependencies: ["React Query", "bcrypt.js", "JWT"],
    ...
    links: {
      ...
      youtube: {
        url: `https://youtube.com/playlist?list=PLiFooJ43_R5SK0wE1LnaBlyWw-B1Uqpwj&si=nro67NPo5rZt-4bF`,
        enabled: true,
      },
    },
  ...
  },
  {
      ...
      features: [
        {
          ...
          detail:
            "Instantly calculate fees and net payouts for PayPal, SoFi, Karuta Tickets, and Mazoku Bloodstone transactions based on your input.",
        },
        {
          title: "User-Friendly Interface",
          detail:
            "Minimal, clean layout with responsive design makes it easy to use on all screen sizes.",
        },
        {
          title: "Multi-Platform Support",
          detail:
            "Switch between PayPal, SoFi, Karuta Tickets, and Mazoku Bloodstone to get platform-specific fee breakdowns.",
        },
        {
          title: "Currency Switching",
          detail:
            "Seamlessly toggle between USD and INR for SoFi Wist and Mazoku Bloodstone calculations.",
        },
        {
          title: "Customizable Inputs",
          detail:
            "Dynamically adjust transaction values and instantly see updated calculations and results.",
        },
        {
          title: "Optimized Performance",
          detail:
            "Fast and efficient front-end built with Next.js for a smooth user experience.",
        },
      ],
    ...
    links: {
      live: {
        url: `https://paypal-and-sofi-wist-fee-calculator.vercel.app/`,
        enabled: true,
      },
      github: {
        url: `https://github.com/itsmeprinceyt/paypal_calculator_for_sofi`,
        enabled: true,
      },
  ...
  },
  {
      ...
      features: [
        {
          ...
          detail:
            "Add names one by one, in bulk (comma-separated or line-by-line), remove specific entries, or reset the list in one click.",
        },
        {
          title: "Interactive Shuffle System",
          detail:
            "Highlight participants in real-time during a suspenseful shuffle animation. Fully customizable shuffle duration.",
        },
        {
          title: "Flexible Settings",
          detail:
            "Easily adjust shuffle timers and highlight colors via a built-in settings panel.",
        },
        {
          title: "Winner Selection Modes",
          detail:
            "Choose from 'Last One Standing', 'Random Winner', 'Shuffle Mode', or 'Wheel Mode' for unique ways to pick a winner.",
        },
        {
          title: "Winner Announcement",
          detail:
            "Displays the winner prominently with a redirect to a dedicated page. Auto-handles final round behavior when only two participants remain.",
        },
        {
          title: "Seamless Navigation",
          detail:
            "After winner declaration, easily return to the home screen to manage participants or start a new round.",
        },
      ],

      dependencies: ["tailwind-scrollbar"],
    ...
    links: {
      ...
      github: {
        url: `https://github.com/itsmeprinceyt/pickandwin`,
        enabled: true,
      },
      youtube: {
        url: `https://www.youtube.com/watch?v=gBu9qU5doiw`,
        enabled: true,
      },
    },
  ...
  },
  {
    ...
    full_description: {
      ...
      features: [
        {
          ...
          detail:
            "Admins can view, edit, and track purchase details including buyer name, purchase date, item list, cost, and current status.",
        },
        {
          title: "MongoDB Integration",
          detail:
            "Customer and purchase data are stored securely in a MongoDB database with a clear schema structure for easy querying.",
        },
        {
          title: "Admin Dashboard with EJS",
          detail:
            "Renders dynamic admin views using EJS templates to provide a clean and intuitive UI for managing records.",
        },
        {
          title: "Status Indicators",
          detail:
            "Each purchase includes editable fields for payment status and delivery status, allowing real-time updates.",
        },
        {
          title: "Environment-Based Config",
          detail:
            "Utilizes environment variables via dotenv to keep sensitive configuration like DB URI and admin credentials secure.",
        },
        {
      ...
      dependencies: ["ejs.js", "dotenv", "nodemon"],
    ...
    links: {
      ...
      github: {
        url: `https://github.com/itsmeprinceyt/itsmeprince-shop-with-db`,
        enabled: true,
      },
      youtube: { url: ``, enabled: false },
    },
      ...
      features: [
        {
          ...
          detail:
            "Moderate your server with ease using features like ban/kick, bulk delete (purge), automated update announcements, donation notifications, redeem code sharing, and role assignments.",
        },
        {
          title: "ItsMe Prince Shop Integration",
          detail:
            "Fully integrated with the ItsMe Prince Shop’s MySQL backend to manage users, track purchases, edit data, maintain a leaderboard, and let users register, view, and update their purchase profiles.",
        },
        {
          title: "User Roles",
          detail:
            "Assign and manage server roles such as Leaker, Mod, Bot Tester, Client, Code Poster, and Shop Manager with precise control.",
        },
        {
          title: "Slash & Prefix Commands",
          detail:
            "Supports both slash commands (`/`) and traditional prefix-based commands (`!`, `?`, etc.) for flexible and efficient interactions.",
        },
        {
          title: "Utility & Fun Features",
          detail:
            "Packed with interactive commands like avatar display, game ID retrieval, device/PC specs, math operations, and access to personal social links like GitHub, Ko-fi, Instagram, YouTube, WhatsApp, and more.",
        },
      ],

      dependencies: ["discord.js", "dotenv", "nodemon"],
  ...
  },
  {
      ...
      features: [
        {
          ...
          detail:
            "Includes notes directly based on what is being taught in the classroom at my institute, ensuring real-time relevance for students studying alongside me.",
        },
        {
          title: "Minimal UI",
          detail:
            "A clean, distraction-free layout focused on the content, designed for quick access and better reading comfort.",
        },
        {
          title: "Open Access",
          detail:
            "The platform is hosted freely and publicly on GitHub Pages so that anyone can browse and benefit from the notes anytime, anywhere.",
        },
      ],
    ...
    links: {
      live: {
        url: `https://itsmeprinceyt.github.io/e-drive/index.html`,
        enabled: true,
      },
      github: {
        url: `https://github.com/itsmeprinceyt/e-drive`,
        enabled: true,
      },
      youtube: { url: ``, enabled: false },
    },
  ...
  },
  {
    ...
    links: {
      live: {
        url: `https://itsmeprinceyt.github.io/StatisticsCalculator/index.html`,
        enabled: true,
      },
      github: {
        url: `https://github.com/itsmeprinceyt/StatisticsCalculator`,
        enabled: true,
      },
      youtube: { url: ``, enabled: false },
    },
  ...
  },
  {
    ...
    full_description: {
      intro:
        "Karuta Work is a Discord bot built to enhance the Karuta card game experience by automating and simplifying job board management. Originally designed for personal use, it has evolved into a powerful public tool used by many to save time, increase efficiency, and manage cards with ease.",

      features: [
        {
          title: "kkhelp",
          detail:
            "Displays a complete list of available commands and a guide on how to use the bot effectively.",
        },
        {
          title: "kkinvite",
          detail:
            "Generates an invite link to add Karuta Work to your own Discord server with the required permissions.",
        },
        {
          title: "kkscan",
          detail:
            "Analyzes your Karuta job board and highlights which cards are healthy or injured, helping you make quick decisions.",
        },
        {
          title: "kkwork",
          detail:
            "Automatically assigns your available cards to the Karuta job board slots, reducing manual labor.",
        },
        {
          title: "kkbits",
          detail:
            "Calculates total bits or custom total bits with selling price. Can be used by replying to a kbi embed with 'kkbits 2300' (replace 2300 with desired price).",
        },
        {
          title: "kkabout",
          detail:
            "Provides information about the bot, its creator, and how you can support the project.",
        },
        {
          title: "Anti-Spam Cooldown",
          detail:
            "Implements intelligent cooldown timers to prevent command spamming and ensure fair use.",
        },
      ],
    ...
    links: {
      live: { url: "", enabled: false },
      github: {
        url: "https://github.com/itsmeprinceyt/karuta-work",
        enabled: true,
      },
  ...
  },
  {
      ...
      features: [
        {
          ...
          detail:
            "Perform simple mathematical operations directly in Discord using slash or prefix commands.",
        },
        {
          title: "Utility Tools",
          detail:
            "Includes small but useful utilities such as ping checks, server stats, and more to aid server members.",
        },
        {
          title: "Command Handling",
          detail:
            "Built with a clean command handler structure, making it easy to maintain and extend.",
        },
        {
          title: "Custom Server Integration",
          detail:
            "Tailored specifically to match the needs of the ItsMe Prince Discord server community.",
        },
      ],
    ...
    links: {
      live: { url: ``, enabled: false },
      github: {
        url: `https://github.com/itsmeprinceyt/itsmeprince-discord-bot`,
        enabled: true,
      },
      youtube: { url: ``, enabled: false },
    },
  ...
  },
  {
    ...
    full_description: {
      ...
      dependencies: ["cryptography (for secure encryption)"],
    ...
    links: {
      live: { url: ``, enabled: false },
      github: {
        url: `https://github.com/itsmeprinceyt/Sofi_Guild_Manager_Private`,
        enabled: true,
      },
      youtube: { url: ``, enabled: false },
    },
  ...
  },
  {
    ...
    full_description: {
      ...
      dependencies: ["@everapi/freecurrencyapi-js"],
    ...
    links: {
      live: {
        url: `https://currency-exchange-lemon-ten.vercel.app/`,
        enabled: true,
      },
      github: {
        url: `https://github.com/itsmeprinceyt/currency_exchange`,
        enabled: true,
      },
      youtube: {
        url: `https://www.youtube.com/watch?v=hXyu8DO7SQ8`,
        enabled: true,
      },
    },
...
export const miniProjects: Project[] = [
  ...
  },
  {
    ...
    full_description: {
      intro: `Educational demonstration of Time-based One-Time Password (TOTP) authentication. Learn how authenticator apps work offline using shared secrets and time-based cryptography.`,

      usage_examples: [
        "2FA / MFA",
        "Transaction Auth in Banking & financial transactions",
    ...
    links: {
      live: {
        url: `https://totp-itsme-prince.vercel.app`,
        enabled: true,
      },
      github: {
        url: `https://github.com/itsmeprinceyt/totp`,
        enabled: true,
      },
      youtube: {
        url: ``,
      ...
      features: [
        {
          ...
          detail:
            "Automatically extract thumbnails from any valid YouTube video link by simply pasting the URL.",
        },
        {
          title: "High-Resolution Support",
          detail:
            "Offers high-quality thumbnails including max resolution (maxresdefault) when available.",
        },
        {
          title: "One-Click Download",
          detail:
            "Users can directly download thumbnails in one click without any extra steps.",
        },
        {
          title: "Clean UI",
          detail:
            "User-friendly and responsive design powered by Tailwind CSS for optimal viewing across all devices.",
        },
      ],
  ...
  },
  {
    ...
    full_description: {
      ...
      dependencies: ["html-to-image", "browser-image-compression"],
      ...
      features: [
        {
          title: "Hero Section",
          detail:
            "A bold, visually engaging introduction with a headline, subtext, and prominent call-to-action button to immediately capture user attention.",
        },
        {
          title: "Product Features",
          detail:
            "Detailed visual sections to highlight key features and benefits, structured for readability and impact.",
        },
        {
          title: "Responsive Design",
          detail:
            "Optimized layout for mobile, tablet, and desktop devices using Tailwind CSS.",
        },
        {
          title: "Contact Form",
          detail:
            "An easy-to-use form for users to send inquiries, feedback, or requests about the product.",
        },
      ],
      ...
      features: [
        {
          title: "Food Menu",
          detail:
            "Showcases an array of food items with high-quality images, names, descriptions, and prices categorized into sections such as appetizers, main courses, and desserts.",
        },
        {
          title: "Responsive Design",
          detail:
            "Built using Tailwind CSS to ensure the layout is visually appealing and functional across all screen sizes including mobile, tablet, and desktop.",
        },
        {
          title: "Contact and About Us Sections",
          detail:
            "Includes informational pages about the food shop’s background, mission, and ways for customers to get in touch easily.",
        },
      ],
...
export const playgroundProjects: Project[] = [
  {
      ...
      features: [
        {
          ...
          detail:
            "A number appears on the screen, and players must quickly click the matching number from a grid of randomized options.",
        },
        {
          title: "60-Second Timer",
          detail:
            "Each session lasts 60 seconds, encouraging fast-paced interaction and rapid decision-making.",
        },
        {
          title: "High Score Tracking",
          detail:
            "Track and improve your performance by aiming to beat your highest score each time you play.",
        },
      ],
    ...
    links: {
      ...
      github: {
        url: `https://github.com/itsmeprinceyt/reflex-time`,
        enabled: true,
      },
      youtube: { url: ``, enabled: false },
    },
