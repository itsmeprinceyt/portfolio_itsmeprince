...
const devTools: SkillInterface[] = [
  ...
  },
  {
    ...
    SkillInfo: [
      {
        description: [
          "DevOps is a set of practices that combines software development (Dev) and IT operations (Ops) to streamline development cycles and enable continuous delivery.",
          "The best way to learn DevOps is by working on real-world projects and actually deploying them. Many developers struggle with proper deployment — and that alone is a valuable skill.",
          "From setting up environments to configuring actions and triggers, it all falls under the DevOps umbrella. So, the more projects you deploy, the more you'll understand the foundational concepts of DevOps.",
        ],
        Links: [
          {
            linkName: NOT_WATCHED_ANY_COURSE,
